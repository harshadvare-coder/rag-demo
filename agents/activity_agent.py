...
collection = chroma_client.get_or_create_collection(name="activity_faq_collection")


PROMPT_FILE = "prompts/activity_prompt.txt"
...
def load_faqs(faq_file: str = "activity_faq.txt") -> list:
...
def vectorize_faqs(get_embedding_fn):
    ...
    print(f"[ActivityAgent] Vectorization done. Total: {collection.count()}")
